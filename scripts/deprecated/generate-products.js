...
import { generateSKU, resetSkuTracker } from '../shared/sku-generator.js';
...
function generateSimpleProduct(template, category, subcategory, categories, metadata, index) {
  ...
  addAttributeWithLabel('br_window_operation_type', template.window_operation_type);
  addAttributeWithLabel('br_window_material', template.window_material);
  addAttributeWithLabel('br_window_glazing_type', template.window_glazing_type);
  addAttributeWithLabel('br_door_type', template.door_type);
  addAttributeWithLabel('br_door_material', template.door_material);
  addAttributeWithLabel('br_door_core_type', template.door_core_type);
  addAttributeWithLabel('br_drywall_thickness', template.drywall_thickness);
  addAttributeWithLabel('br_fastener_type', template.fastener_type);
  addAttributeWithLabel('br_fastener_subtype', template.fastener_subtype);
  addAttributeWithLabel('br_sheathing_location', template.sheathing_location);
  addAttributeWithLabel('br_underlayment_type', template.underlayment_type);
  addAttributeWithLabel('br_insulation_type', template.insulation_type);
  addAttributeWithLabel('br_insulation_r_value', template.insulation_r_value);
  addAttributeWithLabel('br_light_type', template.light_type);
  addAttributeWithLabel('br_light_technology', template.light_technology);
  addAttributeWithLabel('br_fixture_type', template.fixture_type);
  addAttributeWithLabel('br_fixture_location', template.fixture_location);
